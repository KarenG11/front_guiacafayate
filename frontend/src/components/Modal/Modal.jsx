      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-info">
          ...
          <div className="modal-actions">
            {(item.instagram || item.facebook || item.sitioWeb || item.website) && (
              <div className="modal-social">
                {item.instagram && (
                  <a
                    href={item.instagram.startsWith('http') ? item.instagram : `https://www.instagram.com/${item.instagram.replace('@', '')}`}
                    target="_blank"
                ...
                {item.facebook && (
                  <a
                    href={item.facebook.startsWith('http') ? item.facebook : `https://www.facebook.com/${item.facebook}`}
                    target="_blank"
                    rel="noopener noreferrer"
